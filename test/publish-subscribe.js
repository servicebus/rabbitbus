...
describe('servicebus', function () {
  ...
  describe('#publish & #subscribe', function () {
    ...
    it('sends subsequent messages only after previous messages are acknowledged', function (done) {
      ...
      var subscription = bus.subscribe('my.event.14', { ack: true }, function (
        event
      ) {
        count++
    ...
    it('should use callback in confirm mode with options supplied', function (done) {
      confirmBus.publish('my.event.15', { my: 'event' }, {}, function (
        err,
        ok
      ) {
        done(err)
      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          ...
          setTimeout(function () {
            ...
            bus
              .destroyListener('my.event.30', { force: true })
              .on('success', function () {
                done()
              })
          }, 100)
